  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <MetricCard label="Redis Cache" value="UNKNOWN" status="warning" />
      </div>
...
const ApiTester = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {method !== 'GET' && (
        <div>
          <label className="block text-gray-400 text-xs mb-1">Request Body (JSON)</label>
          <textarea 
            value={body}
...
const DatabaseViewer = () => {
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-green-400 mb-6 border-b border-gray-700 pb-2">Raw Database Viewer</h2>
      <p className="text-gray-400">Select a resource to view raw JSON data directly from the API.</p>
      
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {['Boards', 'Users', 'Audit Logs', 'Automation Jobs'].map((item) => (
          <div key={item} className="bg-gray-800 p-4 rounded border border-gray-700 hover:border-green-500 cursor-pointer transition-colors">
            <Database className="w-8 h-8 text-gray-500 mb-2" />
            <h3 className="font-bold text-gray-200">{item}</h3>
            <p className="text-xs text-gray-500">View Table Data</p>
          </div>
        ))}
      </div>
      ...
      <div className="bg-gray-800 p-4 rounded border border-gray-700 mt-6">
        ...
        <p className="text-sm text-gray-400">
            Direct database modification is disabled in this console. Use the standard UI for Create/Update/Delete operations to ensure data integrity and audit logging.
        </p>
      </div>
    </div>
  );
      ...
      {result && (
        <div className="bg-gray-800 border border-gray-700 rounded overflow-hidden">
            <div className="bg-gray-700 px-4 py-2 flex justify-between items-center">
                ...
                <span className="text-xs text-gray-400">{result.affected_rows} rows affected</span>
            </div>

...
const AuditLogs = () => {
  ...
  const { data: logs = [], isLoading, isError, error, refetch } = useQuery({
    ...
    queryFn: () => getAuditLogs(0, 100, null, filterAction || null),
  ...
  return (
    <div className="p-6">
      ...
      {/* Filter Bar */}
      <div className="mb-6 bg-white p-4 rounded shadow flex gap-4">
         <select 
              ...
              {logs.length === 0 ? (
                ...
                logs.map((log) => (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <span title={log.user_id} className="cursor-help border-b border-dotted">

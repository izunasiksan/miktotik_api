...
const Sidebar = ({ isSidebarOpen, setIsSidebarOpen, isSidebarCollapsed, setIsSidebarCollapsed }) => {
  ...
  const historicalItems = [
    ...
    { path: '/analysis', label: 'Analisis', icon: BarChart2 },
    { path: '/reports', label: 'Reports', icon: FileText },
  ];
  const v2Enabled = (typeof window !== 'undefined' && (localStorage.getItem('enableAnalysisV2') === 'true')) || (import.meta.env && import.meta.env.VITE_ENABLE_ANALYSIS_V2 === 'true');
  ...
  const baseHistoricalItems = v1Enabled ? historicalItems : historicalItems.filter(i => i.path !== '/analysis');
  const effectiveHistoricalItems = v2Enabled ? [...baseHistoricalItems, { path: '/analysis-v2', label: 'Analisis V2', icon: BarChart2 }] : baseHistoricalItems;

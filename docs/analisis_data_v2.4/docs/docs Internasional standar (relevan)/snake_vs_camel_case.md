...
solusi yang paling "bersih" dan tidak merepotkan tim Frontend, gunakan djangorestframework-camel-case (untuk Django) atau alias_generator (untuk FastAPI). Dengan begitu, API Anda akan selalu terlihat menggunakan camelCase oleh dunia luar, sementara kode Python Anda tetap snake_case.
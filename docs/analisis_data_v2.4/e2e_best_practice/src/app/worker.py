...
import app.models.mikrotik  # noqa: F401, E402

# Ensure all models are loaded for SQLAlchemy relationships
import app.models.user  # noqa: F401, E402
from app.core.config import settings  # noqa: E402
from app.scheduler.cron_tasks import run_daily_backups  # noqa: E402
from app.services.aggregation_service import (  # noqa: E402
    run_daily_aggregation_job,
    run_monthly_aggregation_job,
)
from app.services.polling_worker import run_polling_cycle  # noqa: E402
from app.services.retention_service import run_weekly_maintenance  # noqa: E402
...
async def main():
    ...
    logger.info(
        f"✅ Job Added: Polling (every {settings.POLLING_INTERVAL_MINUTES} mins)"
    )

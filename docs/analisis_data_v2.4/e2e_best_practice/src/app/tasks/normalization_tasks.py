...
def run_normalization_task(
    board_id: str, start_time: str, end_time: str, granularity: str = "auto"
):
    """
    ...
    return loop.run_until_complete(
        _run_normalization(board_id, start_time, end_time, granularity)
    )


async def _run_normalization(
    board_id: str, start_time: str, end_time: str, granularity: str
):
    async with SessionLocal() as db:
        try:
            ...
            return {"status": "success", "board_id": board_id, "meta": result["meta"]}

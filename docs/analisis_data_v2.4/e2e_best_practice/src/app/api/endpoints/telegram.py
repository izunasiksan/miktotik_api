...
async def read_bots(
    ...
    return jsonable_encoder(bots, by_alias=True)
...
async def delete_bot(
    ...
    await db.commit()
    # UPDATE 2.4.1 Pastikan response menggunakan camelCase
    return jsonable_encoder({"message": "Bot deleted successfully"}, by_alias=True)
...
async def read_recipients(
    ...
    # UPDATE 2.4.1 Pastikan response menggunakan camelCase
    return jsonable_encoder(recipients, by_alias=True)
...
async def create_recipient(
    ...
    # UPDATE 2.4.1 Pastikan response menggunakan camelCase
    return jsonable_encoder(recipient, by_alias=True)
...
async def delete_recipient(
    ...
    await db.commit()
    # UPDATE 2.4.1 Pastikan response menggunakan camelCase
    return jsonable_encoder({"message": "Recipient deleted successfully"}, by_alias=True)

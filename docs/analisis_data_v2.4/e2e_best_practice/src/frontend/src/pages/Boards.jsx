                          ...
                          <div className="ml-4">
                            ...
                            <div className="flex gap-2 mt-1">
                                <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-slate-100 text-slate-600">
                                    {board.site?.siteName || 'Tanpa Site'}
                                </span>
                                <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-indigo-50 text-indigo-600">
                                    {board.boardModelRel?.modelName || 'Model Unknown'}
                                </span>
                            </div>
                          </div>
                        </div>
        ...
        {filteredBoards.map((board) => (
          <div key={board.boardId} className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 flex flex-col gap-3 group hover:border-indigo-200 transition-all">
            ...
            <div className="text-xs text-slate-600">
              ...
              <div className="flex gap-2 mt-1">
                <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-slate-100 text-slate-600">{board.site?.siteName || 'Tanpa Site'}</span>
                <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-indigo-50 text-indigo-600">{board.boardModelRel?.modelName || 'Model Unknown'}</span>
              </div>
            </div>

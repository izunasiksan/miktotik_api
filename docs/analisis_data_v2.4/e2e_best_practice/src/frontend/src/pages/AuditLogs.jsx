    ...
    <div className="p-6">
      ...
      <div className="mb-6 bg-white p-4 rounded shadow flex flex-wrap gap-4 items-end">
         <div className="flex flex-col">
            <label htmlFor="audit-action-select" className="text-xs font-semibold text-gray-500 mb-1">Action</label>
            <select 
               id="audit-action-select"
               name="audit-action-select"
         ...
         <div className="flex flex-col">
            <label htmlFor="audit-start-time" className="text-xs font-semibold text-gray-500 mb-1">Start Time (ISO)</label>
            <input 
               id="audit-start-time"
               name="audit-start-time"
               type="datetime-local" 
               className="border p-2 rounded text-sm h-10"
               value={startTime}
         ...
         <div className="flex flex-col">
            <label htmlFor="audit-end-time" className="text-xs font-semibold text-gray-500 mb-1">End Time (ISO)</label>
            <input 
               id="audit-end-time"
               name="audit-end-time"
               type="datetime-local" 

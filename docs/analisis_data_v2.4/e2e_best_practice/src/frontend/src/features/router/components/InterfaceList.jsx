      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          <div className="relative">
            <label htmlFor="interface-search-input" className="sr-only">Search interface</label>
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
            <input
              id="interface-search-input"
              name="searchTerm"
              type="text"
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1 sm:pb-0">
            <label htmlFor="interface-type-filter" className="sr-only">Filter by type</label>
            <Filter className="w-5 h-5 text-gray-500" />
            <select
              id="interface-type-filter"
              name="filterType"
              value={filterType}

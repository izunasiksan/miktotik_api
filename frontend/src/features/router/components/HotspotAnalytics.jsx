      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-4">
            <div className="flex flex-col">
                <label className="text-[10px] font-semibold text-gray-500 mb-0.5">Start Time (ISO)</label>
                <input 
                    type="datetime-local" 
            ...
            <div className="flex flex-col">
                <label className="text-[10px] font-semibold text-gray-500 mb-0.5">End Time (ISO)</label>
                <input 
                    type="datetime-local" 
                    className="border p-1.5 rounded text-xs h-8"
                    value={endTime}

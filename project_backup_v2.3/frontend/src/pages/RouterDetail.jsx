...
import InterfaceList from '../components/router/InterfaceList.jsx';
import RouterLogs from '../components/router/RouterLogs.jsx';
import BackupManager from '../components/router/BackupManager.jsx';
import PPPoEMonitor from '../components/router/PPPoEMonitor.jsx';
import HotspotAnalytics from '../components/router/HotspotAnalytics.jsx';
import HotspotMonitor from '../components/router/HotspotMonitor.jsx';
import VPNManager from '../components/router/VPNManager.jsx';
    ...
    <div className="p-6 animate-in fade-in duration-500">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
            ...
            <div>
                <h1 className="text-2xl font-bold text-gray-900">{board.board_name}</h1>
                <div className="flex items-center gap-2 mt-0.5">
                    <p className="text-sm text-gray-500">{board.ip_address} | {board.mikrotik_identity}</p>
                    {board.is_online ? (
                ...
                <div className="bg-white p-6 rounded-lg shadow border-l-4 border-blue-500">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900">{stats?.cpu_load || 0}%</p>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900">
                                {(Number(stats?.free_memory) / 1024 / 1024 || 0).toFixed(1)} MB
                            </p>
                        </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow border-l-4 border-yellow-500">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900">
                                {(Number(stats?.free_hdd) / 1024 / 1024 || 0).toFixed(1)} MB
                            </p>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between border-b pb-2">
                            ...
                            <span className="font-medium">{board.board_model || 'Unknown'}</span>
                        </div>
                        <div className="flex justify-between border-b pb-2">
                            <span className="text-gray-500">RouterOS Version</span>
                            <span className="font-medium">{board.router_os_version || '-'}</span>
                        </div>
                        <div className="flex justify-between border-b pb-2">
                            <span className="text-gray-500">Site Group</span>
                            <span className="font-medium">{board.site_group}</span>
                        </div>
                        <div className="flex justify-between border-b pb-2">
                            <span className="text-gray-500">API Port</span>
                            <span className="font-medium">{board.port_api}</span>
                        </div>
                        <div className="flex justify-between border-b pb-2">
                            <span className="text-gray-500">SSH Port</span>
                            <span className="font-medium">{board.port_ssh || 22}</span>
                        </div>
                    </div>
                </div>

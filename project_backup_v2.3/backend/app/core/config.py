...
class Settings(BaseSettings):
    ...
    # CORS
    BACKEND_CORS_ORIGINS: list[str] = ["http://localhost:3000", "http://localhost:8000", "http://localhost:5173"] # REMEDIATION: Specific domains only

    # SECURITY - PHASE 11
    ALLOWED_ADMIN_IPS: list[str] = ["127.0.0.1", "localhost", "::1"] # Default to local only
    ...
    # SYSTEM
    ENABLE_SCHEDULER: bool = False  # Default True for backward compatibility (monolithic run)

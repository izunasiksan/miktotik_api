...
1.  **Reliability**: Apakah sistem memiliki failover mechanism? (Ya/Tidak)
2.  **Accuracy**: Apakah selisih data raw vs agregat < 0.1%? (Ya/Tidak)
3.  **Scalability**: Apakah penambahan board baru berdampak linear terhadap performa? (Ya/Tidak)

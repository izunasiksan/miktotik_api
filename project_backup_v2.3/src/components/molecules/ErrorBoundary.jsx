...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex items-center justify-center bg-slate-50 p-6 rounded-2xl border-2 border-dashed border-rose-200">
          <div className="text-center max-w-md">
            ...
            <p className="text-slate-500 text-sm mb-6">
              Terjadi kesalahan fatal saat merender komponen ini. Pipeline audit mungkin terganggu.
            </p>
            ...
            <button
              ...
              className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-indigo-200 flex items-center gap-2 mx-auto"
            >

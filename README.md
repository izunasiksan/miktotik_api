...
## 📦 Pengembangan (Development) v2.4

Untuk memudahkan investigasi dan pengembangan aplikasi secara real-time, kami merekomendasikan strategi **Redis-as-a-Service**:
- Docker hanya digunakan untuk menjalankan **Redis (Cache)**.
- **Backend & Frontend** dijalankan secara native di localhost.

Lihat panduan lengkapnya di: [DOCKER_DEV_GUIDE.md](file:///e:/mikrotik_api/DOCKER_DEV_GUIDE.md)

### Langkah Cepat Dev:
1. Jalankan Redis: `docker-compose -f docker-compose.dev.yml up -d`
